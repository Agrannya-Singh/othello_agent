...
class Grid:
    ...
    def insertToken(self, grid, curplayer, y, x):
        token_colour = self.whitetoken_colour if curplayer == 1 else self.blacktoken_colour
        self.tokens[(y, x)] = Token(curplayer, y, x, token_colour, self.GAME)
...
class Token:
    def __init__(self, player, gridX, gridY,colour, image, main):
        self.player = player
        self.gridX = gridX
        self.gridY = gridY
